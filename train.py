...
def setup_training_options(
    ...
    cfg_specs = {
        'arsh1':         dict(ref_gpus=1,  kimg=25000,  mb=4,  mbstd=4,  fmaps=1,   lrate=0.001,  gamma=10,   ema=10,  ramp=None, map=8),
        'arsh2':         dict(ref_gpus=1,  kimg=25000,  mb=8,  mbstd=8,  fmaps=1,   lrate=0.001,  gamma=10,   ema=10,  ramp=None, map=8),
        'arsh3':         dict(ref_gpus=1,  kimg=25000,  mb=8,  mbstd=8,  fmaps=1,   lrate=0.0005, gamma=10,   ema=10,  ramp=None, map=8),
        'arsh4':         dict(ref_gpus=1,  kimg=25000,  mb=8,  mbstd=8,  fmaps=1,   lrate=0.0002, gamma=10,   ema=10,  ramp=None, map=8),
        'arsh5':         dict(ref_gpus=1,  kimg=25000,  mb=8,  mbstd=8,  fmaps=1,   lrate=0.0004, gamma=10,   ema=10,  ramp=None, map=8),
...
def main():
    ...
    group.add_argument('--cfg',   help='Base config (default: auto)', choices=['arsh1', 'arsh2', 'arsh3', 'arsh4', 'arsh5', 'auto', 'stylegan2', 'paper256', 'paper512', 'paper1024', 'cifar', 'cifarbaseline'])
